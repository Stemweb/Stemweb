...
def unirun(stopsign,runresque,run_args):
    # assign parameters
...
def uni(run_args):
    ...
    unirunproc = multiprocessing.Process(target=unirun, args=(stopsign,runresque,run_args,))
    unirunproc.start()
...
run_args = dict({'itermaxin' :100, 
'runmax'    : 2, 
'infile'    : 'test.nex', 
'outfolder' : './temp',
'source':'/home/zou/Desktop/Stemwebedit/semsep_stop_len/allunilen.r'})
