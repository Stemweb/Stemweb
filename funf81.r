...
iterationrun <- function(runmax, approximation, runres, bestres, iter)
{ 
	...
	firststagerunres = list("bestres"=bestres,"runres"=runres,"itertime"=itertime)
	invisible (firststagerunres)
...
initiationrun <- function(runmax, itermax, filein, approximation)
{
	...
	initiationrunres = list("bestres"=bestres,"runres"=runres)
